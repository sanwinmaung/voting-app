...
<body class="font-sans bg-gray-background text-gray-900 text-sm">
    <header class="flex items-center justify-between px-48 py-4">
        ...
        <a href="#">
            <img src="https://www.gravatar.com/avatar/00000000000?d=mp" alt="avatar" class="w-10 h-10 rounded-full">
        </a>
    </div>
</header>
...
<main class="container mx-auto max-w-custom flex">
    <div class="w-70 mr-5">
        Add idea form goes here. Lorem ipsum dolor sit amet consectetur adipisicing elit. Vel, asperiores reprehenderit. Veniam sapiente et sed impedit, aliquid blanditiis dignissimos reprehenderit odio laboriosam porro quod vero, nostrum tempore quasi nulla excepturi dolor ducimus, dolorum fuga expedita dolores nisi laborum error ipsum!
    </div>
    <div class="w-175">
